...
//            System.out.println(c1.getNumberOfWheels());
        ...
        Vehicle v3 = new Vehicle(2, "LS15 SIM");
        ...
        Car c2 = new Car("Mini", "One",120);
        c2.setNumOfDoors(4);
        c2.setRegistration("Mini 08");
        System.out.println("c2 :\n" + c2);

        String serviceInfo = c2.performService();
        System.out.println(serviceInfo);


        // create an array of vehicles and loop through to print out vehicle and service info
        Vehicle[] vehicles = {v1, v2, v3, c2};
